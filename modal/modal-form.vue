<template>
  <div class="modal-form">
    <div class="modalform-bg" @click="closeAllModals" />
    <div class="form__main">
      <div class="close" @click="closeAllModals">
        <icons icon="ooui:close" />
      </div>
      ...
      <div class="form-start">
        ...
        <div class="form_start__contacts">
          ...
          <div class="form_start__mail">
            <a href="mailto:Customer.citydeft@gmail.com" target="_blank" rel="noopener">
              customer.citydeft@gmail.com
            </a>
          </div>
        </div>
      ...
      <!-- вторая часть пока не используется -->
...
import vForm from "../components/templates/v-form.vue";
...
const social = reactive([
  {
    ...
    link:
      "https://api.whatsapp.com/send/?phone=905077060007&text&type=phone_number&app_absent=0",
  },
  {
    icon: "file-icons:telegram",
    link: "https://t.me/DEFT_GROUP_turkey",
  },
]);
